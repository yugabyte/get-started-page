<template>
  ...
  <ol>
    ...
    <li>
      ...
      <p>
        This repository contains the <code>yb-voyager</code> rpm and other
        dependencies required to run <code>yb-voyager</code>.
      </p>
    </li>
    ...
    <li>
      <p>
        Install the Oracle instant client repositories using the following
        command:
      </p>
